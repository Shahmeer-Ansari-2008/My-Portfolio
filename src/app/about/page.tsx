...
export default function Home() {
  ...
  Home
        ...
        <li className="leading-[80px] mx-[5px] block m-[50px 0] leading-[30px] mt-[-80px]">
          <Link className="text-white text-base py-2 px-3.5 rounded-sm uppercase text-[16px]  hover:bg-white hover:text-cyan-500 active: font-bold underline " rel="stylesheet"
           href="/about">
          About
          </Link>
        </li>
        ...
        <h1 className="text-center text-cyan-500 text-[50px] underline font-bold">
         About
    </h1>
